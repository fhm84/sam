...
public class DataConversion {
    ...
    void shouldConvert() throws Exception {
        ...
        List<SheetMusic> list = jsonValues.stream().map(this::convertToSheetMusic).toList();
    ...
    void export(final SheetMusic sheetMusic, final Jsonb jsonb) throws IOException {
        ...
        try {
            outputStream = Files.newOutputStream(Paths.get("", "src", "test", "resources", "data", filename), StandardOpenOption.CREATE_NEW);
