...
ALTER TABLE instruments
    ADD COLUMN family varchar(32);
ALTER TABLE instruments
    ADD COLUMN defaultClef varchar(16);
ALTER TABLE instruments
    ADD COLUMN catalogSection varchar(255);
ALTER TABLE instruments
    ADD COLUMN catalogPosition integer;

ALTER TABLE instruments_aud
    ADD COLUMN family varchar(32);
ALTER TABLE instruments_aud
    ADD COLUMN defaultClef varchar(16);
ALTER TABLE instruments_aud
...
(
    instrument_id varchar(255) not null references instruments (id) on delete cascade,
