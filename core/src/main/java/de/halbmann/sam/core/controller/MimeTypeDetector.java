...
public class MimeTypeDetector {
    ...
    /**
     * The Apache Tika™ toolkit detects and extracts metadata and text from over a thousand different
     * file types (such as PPT, XLS, and PDF). All of these file types can be parsed through a single
     * interface, making Tika useful for search engine indexing, content analysis, translation, and
     * much more.
     *
     * <p>The current implementation allows Tika to search for a magic header of the file. However,
     * according to own research, Tika analyzes the content of the file, checks whether an identifier
     * of the mime type is given in the first bytes of the stream and then makes a precise "guess" as
     * to which one is most likely.
     *
